...
var sValorCal="";
			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						...
						sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #f51010; background-color: #f51010";
					}
				}
			}
	...
	if (sErr == ""){
		...
		document.getElementById("ca").innerHTML= nCalif;
	}
